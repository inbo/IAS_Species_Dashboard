...
cells_of_prot_areas <- read_tsv(
  file = "https://raw.githubusercontent.com/trias-project/indicators/master/data/interim/EEA_ref_grid_cells_covering_protected_areas.tsv"
  ,
  na = ""
)
```
