...
renderPlot({
  ...
  if(gam_occupancy == "error"){
    alt_plot <- df_key %>% 
      ...
      ylab("occupancy (km2)") +
      geom_point(stat = "identity") +
      annotate("text", x = max(df_key$year), y = max(df_key$sac_ncells), label = paste0("The emergence status of \n", input$species, " \n cannot be assessed."),vjust = "inward", hjust = "inward", colour = "red")
    print(alt_plot)
  }
...
renderPlot({
  ...
  if(gam_observations == "error"){
    alt_plot <- df_key %>% 
      ggplot(aes(x = year, y = sac_obs)) + 
      ylab("observations") +
      geom_point(stat = "identity") +
      annotate("text", x = max(df_key$year), y = max(df_key$sac_obs), label = paste0("The emergence status of \n", input$species, " \n cannot be assessed."),vjust = "inward", hjust = "inward", colour = "red")
    print(alt_plot)
  }
...
renderPlot({
  ...
  if(gam_occupancy == "error"){
    alt_plot <- df_key %>% 
      ggplot(aes(x = year, y = spa_ncells)) + 
      ylab("occupancy (km2)") +
      geom_point(stat = "identity") +
      annotate("text", x = max(df_key$year), y = max(df_key$spa_ncells), label = paste0("The emergence status of \n", input$species, " \n cannot be assessed."),vjust = "inward", hjust = "inward", colour = "red")
    print(alt_plot)
  }
...
renderPlot({
  ...
  if(gam_observations == "error"){
    alt_plot <- df_key %>% 
      ggplot(aes(x = year, y = spa_obs)) + 
      ylab("observations") +
      geom_point(stat = "identity") +
      annotate("text", x = max(df_key$year), y = max(df_key$spa_obs), label = paste0("The emergence status of \n", input$species, " \n cannot be assessed."),vjust = "inward", hjust = "inward", colour = "red")
    print(alt_plot)
  }
